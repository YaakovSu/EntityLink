...
(function () {
    ...
    CM.resultList = {
        ...
        renderList: function () {
            ...
            html+='<div class="box3">'
            html+='<div class="shuru">'
            html+='<div class="wenbenxianshi">'
            html+='<img src="imagenew/biaoti01.png">'
            html+='</div>'
            html+='<div class="box4">'
            html+='<div id="stcq2" class="cixingboxt" style="display: block;">'
            html+='<textarea class="input">'+yagoText+'</textarea>'
            html+='</div>'
            html+='</div>'
            html+='</div>'
            html+='<div>'
            html+='<div class="fenxi">'
            html+='<img src="imagenew/fenlan.png">'
            html+='</div>'
            html+='<div id="nav" style="position: absolute; top: 623px;">'
            html+='<div class="shudaohang">'
            html+='<div id="menu1" class="kuai">'
            html+='<img class="anniu01" src="imagenew/tubiao01.png">'
            html+='<a href="#box-1" class="a1">分词标注</a>'
            html+='</div>'
            html+='<div id="menu2" class="anniu02">'
            html+='<img class="anniu01" src="imagenew/tubiao02.png">'
            html+='<a href="#box-2" class="a1">实体抽取</a>'
            html+='</div>'
            html+='<div id="menu3" class="anniu02">'
            html+='<img class="anniu01" src="imagenew/tubiao03.png">'
            html+=' <a href="#box-3" class="a1">词频统计</a>'
            html+='</div>'
            html+='<div id="menu4" class="anniu02">'
            html+='<img class="anniu01" src="imagenew/tubiao04.png">'
            html+='<a href="#box-4" class="a1">文本分类</a>'
            html+='</div>'
            html+='<div id="menu5" class="anniu02">'
            html+='<img class="anniu01" src="imagenew/tubiao05.png">'
            html+='<a href="#box-5" class="a1">情感分析</a>'
            html+='</div>'
            html+='<div id="menu6" class="anniu02">'
            html+='<img class="anniu01" src="imagenew/tubiao06.png">'
            html+='<a href="#box-6" class="a1">关键词提取</a>'
            html+='</div>'
            html+='<div id="menu7" class="anniu02">'
            html+='<img class="anniu01" src="imagenew/tubiao07.png">'
            html+='<a href="#box-7" class="a1">Word2vec</a>'
            html+='</div>'
            html+='<div id="menu8" class="anniu02">'
            html+='<img class="anniu01" src="imagenew/tubiao08.png">'
            html+='<a href="#box-8" class="a1">依存文法</a>'
            html+='</div>'
            html+='<div id="menu9" class="anniu02">'
            html+='<img class="anniu01" src="imagenew/tubiao09.png">'
            html+='<a href="#box-9" class="a1">繁简转换</a>'
            html+='</div>'
            html+='<div id="menu10" class="anniu02">'
            html+='<img class="anniu01" src="imagenew/tubiao10.png">'
            html+='<a href="#box-10" class="a1">自动注音</a>'
            html+='</div>'
            html+='<div id="menu11" class="anniu02">'
            html+='<img class="anniu01" src="imagenew/tubiao11.png">'
            html+='<a href="#box-11" class="a1">摘要提取</a>'
            html+='</div>'
            html+='</div>'
            html+='</div>'
            html+='</div>'
            html+='<div class="gongneng">'
            html+='<div id="box-1" class="g2-2">'
            html+='<div class="cixingfenxi0">'
            html+='<img src="imagenew/biaoti01.png">'
            html+='</div>'

            html+='<div id="stcq2" class="shurukuang01" style="display: block;">'
            html+='展示中文维基文本'
            html+='</div>'
            html+='</div>'

            html+='<div id="box-2" class="g2-2">'
            html+='<div class="cixingfenxi0">'
            html+='<img src="imagenew/biaoti01.png">'
            html+='</div>'
            ...
            html+='<div id="box-3" class="g2-2">'
            html+='<img class="biaoti" src="imagenew/biaoti02.png">'
            html+='<a href="javascript:void(0);" style="display:table;">'
            html+='<img id="tb2" class="wendang00" src="imagenew/tubiaoxg.png">'
            html+='</a>'
            html+='<div id="stcq1" class="shurukuang01" style="display: block;">'

            html+='</div>'
            html+=' </div>'
            html+='<div id="box-4" class="g2-2">'
            html+='<div class="cixingfenxi0">'
            html+='<img src="imagenew/biaoti01.png">'
            html+='<a href="html/fenci-1.html" target="_black">'
            html+='<img class="xiayiye" src="imagenew/wendang.png" alt="分词标注简介" title="分词标注简介">'
            html+=' </a>'
            html+='</div>'
            html+='<div id="stcq2" class="shurukuang01" style="display: block;">'
            html+='<br>'
...
///////////////////////////////////////////////////////////////////////////////////////////
    ...
    CM.search = {
        ...
        request: function (query, start, type) {
            ...
            var link = null;
            if (type == 0) {
                link = 'http://58.198.176.48:8080/SearchAction';
            }
            /*else {
...
///////////////////////////////////////////////////////新加入的词云插件//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  var i=0;
    var oTag=null;
        ciyundata = data.dataMap.graphJson
        console.log("这里getjson");
        var items = [];
        $.each( ciyundata, function( key, val ) {
