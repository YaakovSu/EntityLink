...
/**
 * Created by CBD_O9 on 2014-11-22.
 */
...
public class SimpleSvm {
    ...
    public static void main(String[] args) throws IOException {
        ...
        double[][] X = new double[10000][11];
        String trainFile = "C:\\youngsu\\libsvm-3.20\\windows\\train_old.output";
        ...
        double[] test_y = new double[10000];
        double[][] test_X = new double[10000][11];
        String testFile = "C:\\youngsu\\libsvm-3.20\\windows\\train.output";
